...
from maintenance import MaintenanceStatusByProperty, MaintenanceByProperty, MaintenanceStatusByOwner, \
    ...
    MaintenanceDashboard, MaintenanceStatusForOwner, MaintenanceStatusForTenant, MaintenanceStatusForPropertyManager, \
    MaintenanceStatusForMaintenancePerson
...
api.add_resource(MaintenanceStatusForOwner, '/maintenanceStatusForOwner')
api.add_resource(MaintenanceStatusForTenant, '/maintenanceStatusForTenant')
api.add_resource(MaintenanceStatusForPropertyManager, '/maintenanceStatusForPropertyManager')
api.add_resource(MaintenanceStatusForMaintenancePerson, '/maintenanceStatusForMaintenancePerson')
