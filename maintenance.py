        ...
        if uid[:3] == '110':
            ...
            with connect() as db:
                ownerQuery = db.execute(""" 
                                        ...
                                        , maintenance_info.business_uid as maint_business_uid, maintenance_info.business_type as maint_business_type, maintenance_info.business_name as maint_business_name, maintenance_info.business_phone_number as maint_business_phone_number, maintenance_info.business_email as maint_business_email, maintenance_info.business_address as maint_business_address, maintenance_info.business_unit as maint_business_unit, maintenance_info.business_city as maint_business_city, maintenance_info.business_state as maint_business_state, maintenance_info.business_zip as maint_business_zip, maintenance_info.business_photo_url as maint_business_photo_url, maintenance_info.business_paypal as maint_business_paypal, maintenance_info.business_apple_pay as maint_business_apple_pay, maintenance_info.business_zelle as maint_business_zelle, maintenance_info.business_venmo as maint_business_venmo, maintenance_info.business_account_number as maint_business_account_number,maintenance_info.business_routing_number as maint_business_routing_number
