...
class endPointTest_CLASS(Resource):
    def get():
        ...
        try:
            ...
            print("\n*** Completed ***\n")
            response['insert_temporary_data'] = 'Passed / Inserted in space_prod'

        except:
            response['insert_temporary_data'] = 'Failed'

        if response['insert_temporary_data'] != 'Passed / Inserted in space_prod':
        ...
        try:
            ...
            print("\n*** Completed ***\n")
            response['delete_temporary_data'] = 'Passed / deleted from space_prod'
