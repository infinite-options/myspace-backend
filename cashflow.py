    ...
    def put(self):
        ...
        for payment_uid in payment_uids:
            ...
            with connect() as db:
                ...
                response['payment_info'] = db.update('space_dev.payments', key, payload)
        ...
        with connect() as db:
            ...
            if filter == 'payment':
                ...
                response = db.execute("""                          
                        ...
                        LEFT JOIN space_dev.p_details ON property_uid = pur_property_id
                ...
                response = db.execute("""                          
                        ...
                        LEFT JOIN space_dev.property_owner ON pur_property_id = property_id
