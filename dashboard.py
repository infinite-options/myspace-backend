            ...
            if business_type != "MANAGEMENT":
                ...
                with connect() as db:
                    ...
                    delta_cashflow = db.execute("""
                                SELECT -- *,
                                    owner_uid, owner_first_name, owner_last_name, owner_phone_number, owner_email, owner_photo_url, business_uid -- , cf_month, cf_year, expected_cashflow, actual_cashflow, delta_cashflow, percent_delta_cashflow
