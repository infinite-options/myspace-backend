    ...
    def get(self):
        ...
        with connect() as db:
            query = """ 
                ...
                FROM space_dev.m_details
                    LEFT JOIN space_dev.properties ON property_uid = maintenance_property_id
                    LEFT JOIN space_dev.businessProfileInfo ON quote_business_id = business_uid
    ...
    def post(self):
        ...
        with connect() as db:
            for quote_business_id in quote_maintenance_contacts:
                ...
                quote = {}
                quote["maintenance_quote_uid"] = db.call('space_dev.new_quote_uid')['result'][0]['new_id']
                ...
                query_response = db.insert('space_dev.maintenanceQuotes', quote)
